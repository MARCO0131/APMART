...
<html>
    <head>
        ...
        <title>RA MART - Pending Orders</title>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table ucp-table table-hover">
                                            ...
                                            <tbody>
                                                <%
                                                    List<Order> list1;
                                                    String condition = "WHERE order_list.status = 1";
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="action-btns">
                                                        ...
                                                        <a href="edit_order.jsp?order_list_id=<%=e1.getOrder_list_id()%>&action=admin_panding" class="edit-btn"><i class="fas fa-edit"></i></a>
                                                    </td>
                                                </tr>
                                                <%}%>
