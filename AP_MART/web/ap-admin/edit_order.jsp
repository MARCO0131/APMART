...
<html>
    <head>
        ...
        <title>RA MART - Edit Order</title>
                            ...
                            <div class="card card-static-2 mb-30">
                                <%
                                    ...
                                    if (e5.getStatus() == 1) {
                                        ...
                                        status = "On the way";
                                    } else if (e5.getStatus() == 4 || e5.getStatus() == 5) {
                                        status = "Success";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card card-static-2 mb-30 mt-30">
                                                ...
                                                <div class="card-body-table pb-3 px-3">
                                        ...
                                        <div class="col-lg-5">
                                            <form method="post" action="../orderStatusUpadateServlet">
                                                <div class="select-status">
                                                    ...
                                                    <input type="hidden" name="type" <%if (action.equals("admin_panding")){%>value="admin1"<%}else{%>value="admin2"<%}%>>
                                                    <label for="status">Status*</label>
                                                    <div class="input-group">
                                                        <select id="status" name="status" class="custom-select">
                                                            <%if (action.equals("admin_panding")){%>
                                                            <option value="2" id="getStatus">Packed</option>
                                                            <%} else {%>
