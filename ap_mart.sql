...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2022 at 08:44 PM
...
(1713, 19, 'I want to cancel due to product quality issues', '');
...
(52, 109, 'Home', 10, 'shivaji nagar ', 325205, 'baran'),
(53, 109, 'Home', 20, 'shivji', 325205, 'baran'),
(54, 109, 'Office', 120, 'jjj', 235656, 'njk');
...
(17, 'ritesh badgotya', 'riteshbadgotya@gmail.com', '7727818750', '', 52, 2, 'Cash on Delivery'),
(18, 'ritesh badgotya', 'riteshbadgotya@gmail.com', '7727818750', '7727818750', 52, 1, 'Cash on Delivery'),
(19, 'ritesh badgotya', 'riteshbadgotya@gmail.com', '7727818750', '7727818750', 52, 2, 'Cash on Delivery');
...
(711, 50, 7, 11, 7, 51, '2', '2021-04-15 21:19:46', '2021-11-28 14:48:53'),
...
(1713, 109, 17, 13, 17, 105, '1', '2021-11-27 11:24:27', '2021-11-27 05:54:27'),
(1719, 109, 17, 19, 17, 105, '1', '2021-11-27 11:24:27', '2021-11-27 05:54:27'),
(1811, 109, 18, 11, 18, 105, '1', '2021-11-29 20:23:07', '2021-11-29 14:53:07'),
(1917, 109, 19, 17, 19, 105, '1', '2021-12-19 22:33:42', '2021-12-19 17:03:42');
...
(1, 'Ritesh Badgotya', 'uchia3091@gmail.com', '7727818750', 'ranu@123', 'img-2.jpg', 'Street no -5, Patel Socity, Hifali, Botad, Gujarat', 'admin'),
(2, 'Ashish Rathore', 'ashish@gmail.com', '9039660680', 'ashish@123', 'ashu.jpeg', 'Sanjantimba - 365535, Amreli, Gujarat', 'admin'),
(3, 'Ravi Ranjan', 'ravi@gmail.com', '9039660680', 'ravi@123', 'ashu.jpeg', 'Shishuvihar- 364001,Bhavnagar, Gujarat', 'admin'),
...
(109, 'ritesh badgotya', 'riteshbadgotya@gmail.com', '7727818750', 'RANUranu12345', NULL, NULL, 'Customer');
...
--
ALTER TABLE `cart`
  MODIFY `cart_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1295;
...
--
ALTER TABLE `delivery_address`
  MODIFY `delivery_address_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `order_detail`
--
ALTER TABLE `order_detail`
  MODIFY `order_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=501;
...
--
ALTER TABLE `wishlist`
  MODIFY `wishlist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=679;
