    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="col-xl-2 col-md-6">
                            <div class="dashboard-report-card purple">
                                <div class="card-content">
                                    ...
                                    <%
                                        String condition1 = "WHERE status = 1";
                            ...
                            <div class="dashboard-report-card info">
                                <div class="card-content">
                                    <span class="card-title">Order Process</span>
                                     <%
                                        String condition2 = "WHERE status = 3  OR status = 2";
                            ...
                            <div class="dashboard-report-card blue">
                                <div class="card-content">
                                    <span class="card-title">ORDER Delivered</span>
                                     <%
                                        String condition3 = "WHERE status = 4 OR status = 5";
                        ...
                        <div class="col-xl-2 col-md-6 mdp">
                            <div class="dashboard-report-card red">
                                <div class="card-content">
                                    ...
                                    <%
                                        String condition4 = "WHERE status = 6";
                                    ...
                                    <div class="table-responsive">
                                        <table class="table ucp-table table-hover">
                                            ...
                                            <tbody>
                                                 <%
                                                    List<Order> list1;
                                                    String condition = "WHERE order_list.status > 3 ";
                                                ...
                                                <tr>
                                                    ...
                                                    <%if(e1.getStatus() != 6){total_amount = total_amount + sub_total_mrp + delivery_charge;}%>
        ...
        <script>
            $(document).ready(function () {
                var amount = <%=Math.round(total_amount*0.03)%>;
                $("#amount").text(amount);
            });
        </script>
    </body>
