...
<html>
    <head>
        ...
        <title>RA MART - Shop Products</title>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="action-btns">
                                                                    ...
                                                                    <a href="../shopProductServlet?user=shop_owner&shop_product_id=<%=e.getShop_product_id()%>&shop_id=<%=e.getShop_id()%>" class="delete-btn" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                                                </td>
                                                            </tr>
                                                            <%}%>
                                                        </tbody>
