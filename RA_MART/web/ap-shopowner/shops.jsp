                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-7">
                            ...
                            <nav class="navbar navbar-light  justify-content-end">
                                <form class="form-inline mt-md-5">
                                    <a href="shop_products.jsp?shop_id=<%=shop_id%>" class="add-btn hover-btn mr-3">Products</a>
                                    <a href="add_shop_owner.jsp?id=<%=user_id%>" class="add-btn hover-btn ">Edit</a>
                                </form>
                            </nav>
                        </div>
                    </div>
