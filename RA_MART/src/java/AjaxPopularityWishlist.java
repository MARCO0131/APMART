 ...
 * @author Ritesh
 */
@WebServlet(urlPatterns = {"/AjaxPopularityWishlist"})
public class AjaxPopularityWishlist extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AjaxPopularityWishlist.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
