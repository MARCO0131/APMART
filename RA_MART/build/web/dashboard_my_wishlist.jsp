...
<%
    ...
    list = ShopProductDAO.ViewWishlistData(user_id,popularity);
    ...
    <body>
                        ...
                        <div class="col-lg-12">
                            <div class="product-top-dt">
                                <div class="product-left-title">
                                    <h2><i class="uil uil-heart"></i>Shopping Wishlist</h2>
                                </div>
                                <div class="product-sort">
                                    <div class="ui selection dropdown vchrt-dropdown">
                                        <input id="popularity1" name="gender" type="hidden" value="default">
                    ...
                    <div class="product-list-view">
                        <div class="row" id="format">
                            ...
                            <div class="col-lg-3 col-md-6 showMore" id="clear" style="<%if (status == "Closed" || e.getShop_status().equals("Closed") || e.getQuantity() == 0) {%>filter: grayscale(100%);<%}%>">
                                ...
                                <div class="product-item mb-30" id="wishlist-hide">
        ...
        <script>
            $(document).ready(function () {
                $("input#popularity1").on("change keyup paste", function (event) {
                    event.preventDefault();
                    var action = $("input#popularity1").val();
                    var user_id = <%=user_id%>;
                    $.ajax({
                        url: 'AjaxPopularityWishlist',
                        type: "post",
