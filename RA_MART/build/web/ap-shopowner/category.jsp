...
<html>
    <head>
        ...
        <title>RA MART - Categories</title>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="action-btns" style="padding-top: 1.8em;">
                                                        ...
                                                        <a href="../deleteImgServlet?user=shop_owner&id=<%= e.getCategories_id()%>&image=<%= e.getImage()%>&source=category" class="edit-btn"><i class="fas fa-trash-alt"></i></a>
                                                    </td>
                                                </tr>
                                                <%}%>
                                            </tbody>
