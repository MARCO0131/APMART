<%-- 
    Document   : view_order
    Created on : 19 Feb, 2021, 12:24:44 PM
    Author     : 
--%>
...
<html>
    <head>
        ...
        <title>RA MART - View Order</title>
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb mb-30">
                        ...
                        <li class="breadcrumb-item"><a href="tracking_order.jsp">Orders</a></li>
                        ...
                        <div class="col-xl-12 col-md-12">
                            <div class="card card-static-2 mb-30">
                               <%
                                    ...
                                    System.out.println(obj.getDelivery_time());
