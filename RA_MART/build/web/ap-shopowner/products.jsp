                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="action-btns" style="padding-top: 2.5em;">
                                                        ...
                                                        <a href="../deleteImgServlet?user=shop_owner&id=<%= e.getProduct_id()%>&image=<%= e.getImage()%>&source=product" class="edit-btn"><i class="fas fa-trash-alt"></i></a>
                                                    </td>
                                                </tr>
                                                <%}%>
                                            </tbody>
