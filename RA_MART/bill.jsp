...
<html>
    <head>
        ...
        <title>RA MART - Bill Invoice</title>
        <style>
            #collapse1{
                overflow-y:scroll;
                max-height:170px;
                        ...
                        <div class="top-header-group">
                            <div class="top-header">
                                ...
                                <div class="header_right">
                                    <a href="dashboard_my_orders.jsp" class="report-btn hover-btn">Track Orders</a>
                                </div>								
                            </div>
                        </div>
                    </div>
                                ...
                                <table id="collapse1" class="table text-right table-striped table-hover table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><%=pro_toal_mrp%></td>
                                            <td class="action-btns text-center" Style="<%if(action == null){%>display:none;<%}%>"><a href="#" class="delete-btn" title="Delete"><i class="fas fa-trash-alt"></i></a></td>
                                        </tr>
                                        <%}%>
